...
extern "C" void ScrSpecial_GetTraderTradedFlag(void)
{
    struct MauvilleOldManTrader *trader = &gSaveBlock1Ptr->oldMan.trader;
    gSpecialVar_Result = trader->alreadyTraded;
}

extern "C" void ScrSpecial_DoesPlayerHaveNoDecorations(void)
{
    u8 i;
...
extern "C" void ScrSpecial_IsDecorationFull(void)
{
    gSpecialVar_Result = FALSE;
...
extern "C" void ScrSpecial_TraderMenuGiveDecoration(void)
{
...
extern "C" void ScrSpecial_TraderDoDecorationTrade(void)
{
    struct MauvilleOldManTrader *trader = &gSaveBlock1Ptr->oldMan.trader;
...
extern "C" void ScrSpecial_TraderMenuGetDecoration(void)
{
