...
{
    struct Pokenav3Struct *state = h_AllocSubstruct<Pokenav3Struct>(POKENAV_SUBSTRUCT_MATCH_CALL_MAIN);
    if (!state)
        return FALSE;
...
{
    struct Pokenav3Struct *state = h_GetSubstructPtr<Pokenav3Struct>(POKENAV_SUBSTRUCT_MATCH_CALL_MAIN);
